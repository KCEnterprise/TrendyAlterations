     ...
     <!-- Header -->
			<header id="header" class="alt">
                <div class="logo">
                    ...
                    <asp:HyperLink ID="hprlogo" runat="server" NavigateUrl="~/homepage.aspx"> <asp:Image ID="Image1" runat="server" href="homepage.aspx"  ImageURL="~/Images/TrendyAlterationsLogo.png" CssClass="auto-style1" Height="208px" Width="225px" /> </asp:HyperLink>
